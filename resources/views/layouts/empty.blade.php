			...
			<div id="breadcrumb">
				<div class="container">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#" title="Fruit">Shop</a></li>
												...
												<div class="product-item">
													<div class="product-image">
														<a href="product-detail-left-sidebar.html">
															<img class="img-responsive" src="{{asset('img/product') }}/{{ $product->image }}" alt="{{ $product->name }}">
														</a>
													</div>
													...
													<div class="product-price">
														...
														<span class="base-price">=N=80</span>
													</div>
										...
										<div class="product-item">
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
													<div class="product-image">
														<a href="product-detail-left-sidebar.html">
															<img class="img-responsive" src="{{asset('img/product/prod_14.jpg')}}" alt="Product Image">
														</a>
													</div>
												</div>
										...
										<div class="product-item">
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
													<div class="product-image">
														<a href="product-detail-left-sidebar.html">
															<img class="img-responsive" src="{{asset('img/product/prod_17.jpg')}}" alt="Product Image">
														</a>
													</div>
												</div>
										...
										<div class="product-item">
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
													<div class="product-image">
														<a href="product-detail-left-sidebar.html">
															<img class="img-responsive" src="{{asset('img/product/prod_8.jpg')}}" alt="Product Image">
														</a>
													</div>
												</div>
										...
										<div class="product-item">
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
													<div class="product-image">
														<a href="product-detail-left-sidebar.html">
															<img class="img-responsive" src="{{asset('img/product/prod_9.jpg')}}" alt="Product Image">
														</a>
													</div>
												</div>
