...
<head>
		...
		<meta name="description" content="Organic, Fresh Food, Tools, Farm Store">
						...
						<div class="row">
							...
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="topbar-left d-flex">
									<div class="email">
										<i class="fa fa-envelope" aria-hidden="true"></i>Email: openhandsfarm@gmail.com
									</div>
									<div class="skype">
										<i class="fa fa-skype" aria-hidden="true"></i>Skype: openhandsfarm
									</div>
								</div>
							</div>
								...
								<div class="topbar-right d-flex justify-content-end">
									...
									<div class="dropdown account">
										...
										<div class="dropdown-menu">									
											<div class="item">
												<a href="/login" title="Log in to your customer account"><i class="fa fa-cog"></i>My Account</a>
											</div>
											<div class="item">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="logo">
									<a href="index.html">
										<img class="img-responsive" src="img/logo-4.png" Width="50%" alt="Logo">
									</a>
								</div>
				...
				<div id="main-menu">
					<ul class="menu">
						<li class="dropdown">
							...
							<div class="dropdown-menu">
								<ul>
									<li><a href="/" title="Homepage 1">Home</a></li>
						...
						<li class="dropdown">
							<a href="/shop" title="Product">Shop</a>
							<div class="dropdown-menu">
								{{-- <ul>
									<li class="has-image">
