													...
													<tr>
														<td class="product-image">
															<a href="product-detail-left-sidebar.html">
																<img src="{{route('product.details', ['slug' => $item->model->slug])}}" alt="Product">
															</a>
														</td>
														<td>
																	...
																	<div class="qty">
																		<div class="input-group">
																			...
																			<span class="adjust-qty">
																				<a href="#"><span class="btn adjust-btn plus">+</span></a>
																				<a href="#"><span class="btn adjust-btn minus">-</span></a>
																			</span>
																		</div>
																	</div>
																</div>
