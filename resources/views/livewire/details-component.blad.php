										...
										<div class="col-md-4 col-sm-12 col-xs-12 product-left">
											<div class="product-image">
												<a href="product-detail-left-sidebar.html">
													<img class="img-responsive" src="{{asset('img/product/prod_4.jpg')}}" alt="Product Image">
												</a>
											</div>
										</div>
								...
								<div class="product-item">
									<div class="row">
										<div class="col-md-4 col-sm-12 col-xs-12 product-left">
											<div class="product-image">
												<a href="product-detail-left-sidebar.html">
													<img class="img-responsive" src="{{asset('img/product/prod_30.jpg')}}" alt="Product Image">
												</a>
											</div>
										</div>
								...
								<div class="product-item">
									<div class="row">
										<div class="col-md-4 col-sm-12 col-xs-12 product-left">
											<div class="product-image">
												<a href="product-detail-left-sidebar.html">
													<img class="img-responsive" src="{{asset('img/product/prod_24.jpg')}}" alt="Product Image">
												</a>
											</div>
										</div>
										...
										<div class="product-left col-md-5 col-sm-5 col-xs-12">
											<div class="product-image horizontal">
												<div class="main-image">
													<img class="img-responsive" src="{{asset('img/product/prod_2.jpg')}}" alt="Product Image">
												</div>
												<div class="thumb-images owl-theme owl-carousel">
													<img class="img-responsive" src="{{asset('img/product/prod_31.jpg')}}" alt="Product Image">
													<img class="img-responsive" src="{{asset('img/product/prod_3.jpg')}}" alt="Product Image">
													<img class="img-responsive" src="{{asset('img/product/prod_7.jpg')}}" alt="Product Image">
													<img class="img-responsive" src="{{asset('img/product/prod_30.jpg')}}" alt="Product Image">
												</div>
											</div>
										</div>
							...
							<div class="block-content">
								<div class="products owl-theme owl-carousel">
									...
									<div class="product-item">
										<div class="product-image">
											<a href="product-detail-left-sidebar.html">
												<img src="{{asset('img/product/prod_15.jpg')}}" alt="Product Image">
											</a>
										</div>
									...
									<div class="product-item">
										<div class="product-image">
											<a href="product-detail-left-sidebar.html">
												<img src="{{asset('img/product/3prod_1.jpg')}}" alt="Product Image">
											</a>
										</div>
